...
export default function Home(){
  ...
  return <><SEO schema={schema}/>
    <section className="hero" ref={hero}><img className="hero__bg" src="/images/nukkad-natak-delhi-performance.webp" width="1680" height="940" fetchPriority="high" alt="Nukkad Natak performers engaging a public audience in Delhi"/><div className="hero__shade"/><div className="hero__content"><span className="eyebrow">NUKKAD NATAK Â· THEATRE Â· PUBLIC OUTREACH</span><h1 aria-label="Stories That Stop Crowds. Messages That Move People.">{['Stories That','Stop Crowds.','Messages That','Move People.'].map((x,i)=><span className={i===2?'accent':''} key={x}><i className="hero__word">{x}</i></span>)}</h1><div className="hero__intro"><p>W.I. Events & Promotions creates powerful street theatre, CSR campaigns, roadshows and audience-focused activations across Delhi and India.</p><div className="button-row"><ButtonLink light>Plan a Campaign</ButtonLink><ButtonLink to="/our-work">Explore Our Work</ButtonLink></div><small>From script development to nationwide on-ground execution.</small></div></div><a href="#impact" className="hero__scroll">SCROLL TO ENTER <ArrowDown/></a></section>
