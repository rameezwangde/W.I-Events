...
export default function Experience(){
  ...
  return <><div className={`opening ${loading?'is-active':''}`} aria-hidden="true"><div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><img src="/images/logo.png" alt="Natak Baaz" style={{ height: '140px', marginBottom: '1.5rem', borderRadius: '8px' }} /><span>THE STREET BECOMES THE STAGE</span></div></div><span ref={cursor} className="cursor" aria-hidden="true"/></>
}
